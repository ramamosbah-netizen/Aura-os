...
3. **Commissioning → handover → activate warranty → start AMC** — the ELV lifecycle chain. *2026-08-01: commissioning (11) + handover (12) built, and handover-accept now auto-starts the AMC contract (13). The chain is connected; the remaining automation is commissioning-complete → auto-open the handover package.*
