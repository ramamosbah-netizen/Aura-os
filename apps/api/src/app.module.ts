 ...
 */
@Module({
  imports: [GatesModule, FinanceWiringModule, ResourceAvailabilityModule, CoreModule, CrmModule, MarketIntelligenceModule, TenderingModule, ContractsModule, ProjectsModule, IntelligenceModule, ProcurementModule, InventoryModule, FinanceModule, SubcontractsModule, EngineeringModule, DocControlModule, SiteModule, HseModule, QualityModule, HrModule, FleetModule, AssetsModule, TemplatesModule, AmcModule, CommissioningModule, ElvModule, ComplianceModule],
