 ...
 */
@Module({
  imports: [CoreModule, CrmModule, TenderingModule, ContractsModule, ProjectsModule],
  controllers: [HealthController, EventsController, DocumentsController, WorkflowController, IntegrationController, AiController, CrmAccountsController, TenderingController, ContractsController, ProjectsController],
