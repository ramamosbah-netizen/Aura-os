...
const st = {
  ...
  ok: { border: '1px solid var(--good-soft)', background: 'var(--good-soft)', borderRadius: 10, padding: '11px 14px', marginBottom: 16, fontSize: 13.5 } as CSSProperties,
  ...
  slaOk: { color: 'var(--good)', fontWeight: 600, fontSize: 12.5 } as CSSProperties,
  slaBad: { color: 'var(--bad)', fontWeight: 700, fontSize: 12.5 } as CSSProperties,
