...
import CustomersWorkspaceClient, { type CustomerAccount, type CustomerContactPage, type CustomerPortfolioPage } from '@/components/customers-workspace-client';
...
export default async function CustomersPage() {
  const [portfolioResult, contactPageResult, accountsResult, user] = await Promise.all([
