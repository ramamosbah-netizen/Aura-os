...
export default function Account360Client({ accountId }: { accountId: string }) {
  ...
  const HEALTH = {
    ...
    attention: { dot: '🟠', label: 'Attention Required', color: 'var(--warn)' },
...
const st = {
  ...
  menu: { position: 'absolute', right: 0, top: 'calc(100% + 4px)', zIndex: 30, background: 'var(--panel)', border: '1px solid var(--border)', borderRadius: 10, padding: 6, minWidth: 220, boxShadow: '0 8px 24px var(--overlay)', display: 'flex', flexDirection: 'column', gap: 2 } as CSSProperties,
  ...
  tabCount: { fontSize: 10, fontWeight: 800, background: 'var(--tint-ink)', borderRadius: 999, padding: '1px 6px' } as CSSProperties,
