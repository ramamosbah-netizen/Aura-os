...
const st = {
  ...
  tabBtnActive: { background: 'var(--panel)', borderColor: 'var(--accent, #2563eb)', color: 'var(--foreground)', boxShadow: 'var(--shadow-sm)' } as CSSProperties,
  ...
  submitBtn: { padding: '8px 14px', borderRadius: 8, border: 'none', background: 'var(--accent, #2563eb)', color: '#fff', fontSize: 12.5, fontWeight: 700, cursor: 'pointer', width: 'fit-content' } as CSSProperties,
