...
const st = {
  ...
  dimLabel: { color: 'var(--text)' } as CSSProperties,
  dimSel: { padding: '3px 6px', borderRadius: 5, border: '1px solid var(--border)', background: 'var(--panel-2)', color: 'var(--text)', fontSize: 12 } as CSSProperties,
  sel: { padding: '5px 8px', borderRadius: 6, border: '1px solid var(--border)', background: 'var(--panel-2)', color: 'var(--text)', fontSize: 13, textTransform: 'capitalize' } as CSSProperties,
