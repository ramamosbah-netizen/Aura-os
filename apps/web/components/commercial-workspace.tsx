...
export default function CommercialWorkspace({ quotations, contracts, sheets, apiDown }: {
  quotations: CommQuotation[]; contracts: CommContract[]; sheets: CommSheet[]; apiDown: boolean;
}) {
