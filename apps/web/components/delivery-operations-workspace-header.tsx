...
import { ArrowRight, ClipboardCheck, FileCheck2, HardHat, LayoutDashboard, PencilRuler, ShieldCheck, Wrench, type LucideIcon } from 'lucide-react';
import styles from './delivery-operations-workspace-header.module.css';

type WorkspaceKey = 'overview' | 'engineering' | 'site' | 'quality' | 'hse' | 'commissioning' | 'handover';
