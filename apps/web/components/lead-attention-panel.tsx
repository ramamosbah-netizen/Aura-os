...
const st = {
  ...
  tabOn: { background: 'var(--panel-2)', color: 'var(--text)', borderColor: 'var(--text)' } as CSSProperties,
  ...
  convertBtn: { fontSize: 12, padding: '3px 9px', borderRadius: 5, border: '1px solid var(--border)', background: 'transparent', color: 'var(--text)', cursor: 'pointer' } as CSSProperties,
  primaryBtn: { fontSize: 12, padding: '3px 9px', borderRadius: 5, border: '1px solid var(--text)', background: 'var(--text)', color: 'var(--panel)', cursor: 'pointer' } as CSSProperties,
