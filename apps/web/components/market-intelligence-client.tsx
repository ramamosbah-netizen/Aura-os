...
const st = {
  ...
  search: { background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, color: 'var(--text)', padding: '8px 11px', fontSize: 13, minWidth: 220 } as CSSProperties,
  select: { background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, color: 'var(--text)', padding: '8px 11px', fontSize: 13 } as CSSProperties,
  addBtn: { background: 'var(--accent)', border: 'none', borderRadius: 8, color: 'var(--accent-ink)', padding: '8px 14px', fontSize: 12.5, fontWeight: 700, cursor: 'pointer' } as CSSProperties,
  seedBtn: { background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, color: 'var(--text)', padding: '8px 14px', fontSize: 12.5, cursor: 'pointer' } as CSSProperties,
  ...
  f: { background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border-strong, var(--border))', borderRadius: 7, color: 'var(--text)', padding: '7px 9px', fontSize: 12.5, width: '100%', boxSizing: 'border-box' } as CSSProperties,
  saveBtn: { background: 'var(--accent)', border: 'none', borderRadius: 7, color: 'var(--accent-ink)', padding: '7px 16px', fontSize: 12.5, fontWeight: 700, cursor: 'pointer' } as CSSProperties,
