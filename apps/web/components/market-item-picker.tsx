...
const st = {
  input: { background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border-strong, var(--border))', borderRadius: 7, color: 'var(--text)', padding: '7px 9px', fontSize: 13, width: '100%', boxSizing: 'border-box' } as CSSProperties,
  menu: { position: 'absolute', top: '100%', left: 0, right: 0, zIndex: 20, marginTop: 4, background: 'var(--panel)', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, boxShadow: '0 10px 30px var(--overlay)', overflow: 'hidden', maxHeight: 320, overflowY: 'auto' } as CSSProperties,
  group: { fontSize: 10.5, textTransform: 'uppercase', letterSpacing: 0.5, color: 'var(--muted)', padding: '7px 10px 3px' } as CSSProperties,
  opt: { display: 'flex', flexDirection: 'column', gap: 1, width: '100%', textAlign: 'left', background: 'transparent', border: 'none', borderTop: '1px solid var(--border)', color: 'var(--text)', padding: '7px 10px', cursor: 'pointer' } as CSSProperties,
