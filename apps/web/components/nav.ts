...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Radar', href: '/crm/pipeline?tab=radar', glyph: '⚡', desc: 'Sales intelligence — new signals before lead qualification' },
      ...
      { label: 'Forecast', href: '/crm/pipeline?tab=forecast', glyph: '◷', desc: 'Expected close, commit and forecast movement' },
      { label: 'Analytics', href: '/crm/pipeline?tab=analytics&view=performance', glyph: '📈', desc: 'Performance, sources, margin and executive analysis' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Compliance', href: '/compliance', glyph: '🛡', desc: 'Authority approvals — SIRA, DCD: submissions, inspections, decisions, certificates and renewals' },
