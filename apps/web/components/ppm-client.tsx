...
const st = {
  ...
  btnAlt: { padding: '8px 18px', borderRadius: 6, background: 'var(--good)', color: 'var(--accent-ink)', border: 'none', fontWeight: 600, cursor: 'pointer', fontSize: 14 } as CSSProperties,
