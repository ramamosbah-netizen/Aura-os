...
const st = {
  ...
  prio: (p: string): CSSProperties => ({ fontSize: 10, fontWeight: 800, textTransform: 'uppercase', padding: '1px 6px', borderRadius: 4, border: '1px solid var(--border)', color: p === 'must' ? 'var(--bad)' : p === 'should' ? 'var(--warn)' : 'var(--muted)' }),
  ...
  sel: { padding: '6px 8px', borderRadius: 6, border: '1px solid var(--border)', background: 'var(--panel-2)', color: 'var(--text)', fontSize: 12.5 } as CSSProperties,
  ...
  discIn: { flex: '0 1 110px', padding: '5px 8px', borderRadius: 6, border: '1px solid var(--border)', background: 'var(--panel-2)', color: 'var(--text)', fontSize: 12 } as CSSProperties,
  qtyIn: { flex: '0 1 70px', width: 70, padding: '5px 8px', borderRadius: 6, border: '1px solid var(--border)', background: 'var(--panel-2)', color: 'var(--text)', fontSize: 12 } as CSSProperties,
