...
const st = {
  ...
  run: { background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, color: 'var(--text)', padding: '6px 13px', fontSize: 12.5, cursor: 'pointer' } as CSSProperties,
  ...
  narrative: { fontSize: 13, lineHeight: 1.6, color: 'var(--text)', margin: '0 0 12px', padding: '10px 12px', background: 'var(--panel-2, var(--panel))', borderRadius: 8, borderLeft: '3px solid var(--accent)' } as CSSProperties,
