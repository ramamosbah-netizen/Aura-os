...
const st = {
  ...
  item: { width: '100%', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: 3, background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border)', borderRadius: 8, padding: '8px 10px', cursor: 'pointer', color: 'var(--text)' } as CSSProperties,
  ...
  numInput: { background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border-strong, var(--border))', borderRadius: 6, color: 'var(--text)', padding: '6px 8px', fontSize: 12.5, width: '100%', boxSizing: 'border-box' } as CSSProperties,
  ...
  histName: { color: 'var(--text)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } as CSSProperties,
  ...
  viewTabOn: { color: 'var(--text)', borderBottomColor: 'var(--accent)', fontWeight: 600 } as CSSProperties,
  sheetBadge: { fontSize: 12, color: 'var(--muted)', border: '1px solid var(--border)', borderRadius: 999, padding: '3px 11px' } as CSSProperties,
  ghostBtn: { background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, color: 'var(--text)', padding: '9px 16px', fontSize: 13, cursor: 'pointer' } as CSSProperties,
