...
const st = {
  ...
  input: { background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, color: 'var(--text)', padding: '9px 11px', fontSize: 13.5, width: '100%', boxSizing: 'border-box' } as CSSProperties,
  ...
  option: { width: '100%', textAlign: 'left', background: 'transparent', border: 'none', color: 'var(--text)', padding: '7px 9px', fontSize: 13, cursor: 'pointer', borderRadius: 6 } as CSSProperties,
  ...
  ghost: { background: 'transparent', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, color: 'var(--text)', padding: '9px 16px', fontSize: 13, cursor: 'pointer' } as CSSProperties,
};
