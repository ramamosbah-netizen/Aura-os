...
const st = {
  openBtn: { background: 'var(--accent)', border: 'none', borderRadius: 8, color: 'var(--accent-ink)', padding: '8px 16px', fontSize: 13, fontWeight: 700, cursor: 'pointer' } as CSSProperties,
  backdrop: { position: 'fixed', inset: 0, background: 'var(--overlay)', display: 'flex', justifyContent: 'flex-end', zIndex: 50 } as CSSProperties,
  ...
  input: { background: 'var(--panel-2, var(--panel))', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, color: 'var(--text, var(--text))', padding: '9px 11px', fontSize: 13.5, width: '100%', boxSizing: 'border-box' } as CSSProperties,
  menu: { listStyle: 'none', margin: '4px 0 0', padding: 4, position: 'absolute', top: '100%', left: 0, right: 0, background: 'var(--panel)', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, zIndex: 5, display: 'flex', flexDirection: 'column', gap: 2, boxShadow: '0 8px 24px var(--overlay)' } as CSSProperties,
  option: { width: '100%', textAlign: 'left', background: 'transparent', border: 'none', color: 'var(--text, var(--text))', padding: '7px 9px', fontSize: 13, cursor: 'pointer', borderRadius: 6 } as CSSProperties,
  ...
  primary: { background: 'var(--accent)', border: 'none', borderRadius: 8, color: 'var(--accent-ink)', padding: '9px 16px', fontSize: 13, fontWeight: 700, cursor: 'pointer' } as CSSProperties,
  ghost: { background: 'transparent', border: '1px solid var(--border-strong, var(--border))', borderRadius: 8, color: 'var(--text, var(--text))', padding: '9px 16px', fontSize: 13, cursor: 'pointer' } as CSSProperties,
};
