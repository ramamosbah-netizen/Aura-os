          ...
          <tbody>
            {rows.map((r) => (
              <>
                ...
                {expanded === r.id && (
                  <tr key={r.id + '-h'}>
                    <td style={{ ...st.td, background: 'var(--panel)' }} colSpan={7}>
...
const st = {
  ...
  kpi: { border: '1px solid var(--border)', borderRadius: 10, padding: '12px 18px', minWidth: 150, background: 'var(--panel)' } as CSSProperties,
