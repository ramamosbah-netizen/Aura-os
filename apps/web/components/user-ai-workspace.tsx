...
const st = {
  ...
  btnApprove: { padding: '8px 14px', background: 'var(--accent)', border: 'none', borderRadius: 8, color: 'var(--accent-ink)', fontSize: 12.5, fontWeight: 700, cursor: 'pointer' } as CSSProperties,
  ...
  errorBanner: { padding: '10px 14px', borderRadius: 8, background: 'var(--bad-soft)', border: '1px solid var(--bad-soft)', color: 'var(--bad)', fontSize: 13, fontWeight: 600 } as CSSProperties,
