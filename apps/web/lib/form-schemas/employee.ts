// Employee form — first full-metadata form on the platform: tabbed layout,
// live business rules, declarative validation. Zero React code; the engine
// renders everything from this object.
