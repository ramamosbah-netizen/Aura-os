// Quotation form — demonstrates calculated fields: live subtotal / VAT /
// grand total computed from the line items via SUMLINES formulas. The
// computed fields are transient (display-only) so the payload the API
// receives is unchanged from the legacy form.
