...
**Totals (Rev 2.3):** P0 = 3 · P1 = **7** · P2 = **5** · P3 = 3 · **Closed = 2** (G-07, G-08). *(Rev 1: P0 3 · P1 9 · P2 5 · P3 3. G-08 walked P1→P2→P3→closed as its modules were governed one by one; G-07 closed outright; no gap was deleted from the register.)*
