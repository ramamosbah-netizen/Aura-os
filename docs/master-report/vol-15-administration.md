...
| Remaining spec sections (form designer §2.4 remainder, §2.7 depth: prompt packs / cost meters, §2.8 digest schedules, list-view/dashboard/menu designers) | — | phase 2+ [Planned] |
