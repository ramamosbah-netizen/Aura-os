...
|---|---|---|---|
| **CRM** | Dashboard, Leads, Opportunities, Customers, Quotations | Accounts page, Sales Pipeline page (Leads & Opportunities with AI Forecast) | Marketing, Segments, Quotations missing |
...
|---|---|
| CRM | Marketing, Segments, Quotations |
