...
Post-audit remediation has started. Wave 0 is closed for its bounded safety scope and Wave 1 is closed for its bounded Sales/Tender-intake-to-governed-study scope. Direct-sale and Tender paths now have persisted, revisioned Technical Studies, canonical DMS inputs/evidence and independent review. Wave 2 remains active for estimate, pricing, approval and customer offer. Current corrections gate direct and Tender quotation bypasses; connect Tender study → independently approved Quantity Take-Off → locked BOQ → pricing → draft offer; prevent legacy/manual BOQ lines from bypassing that chain; require all three governed prerequisites before Tender submission; preserve direct offer line/quantity fidelity; repair revision traversal; and prove real quotation/technical-proposal PDFs plus direct/Tender internal XLSX outputs. The Tender API path now uses intended Pre-Sales, Estimator, Technical Manager and Commercial Manager roles. Direct intended-role browser acceptance, negotiation and restricted-role browser output proof remain open. These corrections do not change the frozen discovery totals; current evidence is recorded in the [Wave 1 Closure Report](./wave-1-progress-report.md) and [Wave 2 Progress Report](./wave-2-progress-report.md).
