...
| 3 | IN PROGRESS | [Wave 3 progress](./wave-3-progress-report.md): the frozen Rev 1 basis now maps canonically into WBS/CBS and the SOLD ledger; controlled drawing transmission and persisted manager-to-assignee delivery responsibility through My Work are verified. Governed engineering receipt and connected planning remain open. |
