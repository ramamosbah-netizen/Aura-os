      ...
      handler: async (command, tx) => {
        ...
        const event = makeEvent({
          ...
          payload: {
            ...
            sourceTenderId: contract.tenderId,
            currency: contract.currency,
            commercialScopeRevisionId: contract.commercialScopeRevisionId,
            boqRevisionId: contract.boqRevisionId,
            estimateRevisionId: contract.estimateRevisionId,
            acceptedQuotationId: contract.acceptedQuotationId,
            acceptedQuotationRevisionId: contract.acceptedQuotationRevisionId,
            commercialBaselineId: contract.commercialBaselineId,
            awardAcceptanceType: contract.awardAcceptanceType,
            awardAcceptanceEvidence: contract.awardAcceptanceEvidence,
  ...
  async changeStatus(id: Id, status: ContractStatus, actorId?: Id): Promise<Contract> {
    ...
    const event = makeEvent({
      ...
      payload: {
        ...
        value: updated.value,
        sourceOpportunityId: updated.sourceOpportunityId,
        sourceTenderId: updated.tenderId,
        currency: updated.currency,
        commercialScopeRevisionId: updated.commercialScopeRevisionId,
        boqRevisionId: updated.boqRevisionId,
        estimateRevisionId: updated.estimateRevisionId,
        acceptedQuotationId: updated.acceptedQuotationId,
        acceptedQuotationRevisionId: updated.acceptedQuotationRevisionId,
        commercialBaselineId: updated.commercialBaselineId,
        awardAcceptanceType: updated.awardAcceptanceType,
        awardAcceptanceEvidence: updated.awardAcceptanceEvidence,
