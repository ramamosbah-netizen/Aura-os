...
import type { PurchaseOrderLine, PurchaseOrderLineSource } from './domain/purchase-order-line';
...
const COLS = `id, tenant_id, company_id, po_id, line_no, material_id, material_code, material_name,
  specification, manufacturer, model, uom, quantity, unit_price, source_type, source_pr_line_id,
  source_quote_line_id, wbs_node_id, cbs_node_id, notes, created_by, created_at`;
  ...
  async save(l: PurchaseOrderLine): Promise<void> {
    await this.pool.query(
      ...
      [l.id, l.tenantId, l.companyId, l.poId, l.lineNo, l.materialId, l.materialCode, l.materialName,
       l.specification, l.manufacturer, l.model, l.uom, l.quantity, l.unitPrice, l.sourceType,
       l.sourcePrLineId, l.sourceQuoteLineId, l.wbsNodeId, l.cbsNodeId, l.notes, l.createdBy, l.createdAt],
    );
  }
