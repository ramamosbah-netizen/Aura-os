  ...
  async save(a: LabourAllocation, tx?: TxHandle): Promise<void> {
    ...
    await conn.query(
      `insert into public.aura_site_labour_allocations (
        id, tenant_id, company_id, project_id, project_name, date, trade, headcount, hours, man_hours, subcontractor_name, notes, created_by, created_at, updated_at, cost_rate, labour_cost, cbs_node_id, subcontractor_id, wbs_node_id
      ...
      on conflict (id) do update set
        ...
        subcontractor_id = excluded.subcontractor_id, wbs_node_id = excluded.wbs_node_id`,
      [a.id, a.tenantId, a.companyId, a.projectId, a.projectName, a.date, a.trade, a.headcount, a.hours, a.manHours, a.subcontractorName, a.notes, a.createdBy, a.createdAt, a.updatedAt, a.costRate, a.labourCost, a.cbsNodeId, a.subcontractorId, a.wbsNodeId],
    );
  }
