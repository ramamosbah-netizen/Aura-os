  ...
  return items.map((item) => {
    ...
    if (!b) {
      return {
        ...
        manpowerTotal: '', transport: '', equipmentRent: '', subcontract: '', otherDirect: '',
        directCostLine: '', indirectPercent: '', indirectAmountLine: '',
        overheadPercent: '', overheadAmountLine: '', riskPercent: '', riskAmountLine: '',
        profitPercent: '', profitAmountLine: '',
    ...
    return {
      ...
      equipmentRent: r ? r.equipmentRent : '',
      subcontract: r ? r.subcontract : '',
      otherDirect: r ? r.otherDirect : '',
      directCostLine: r2(b.directCost * qty),
      indirectPercent: b.indirectPercent ?? 0,
      indirectAmountLine: r2((b.indirectAmount ?? 0) * qty),
      overheadPercent: b.overheadPercent,
      overheadAmountLine: r2(b.overheadAmount * qty),
      riskPercent: b.riskPercent ?? 0,
      riskAmountLine: r2((b.riskAmount ?? 0) * qty),
      profitPercent: b.profitPercent,
      profitAmountLine: r2(b.profitAmount * qty),
