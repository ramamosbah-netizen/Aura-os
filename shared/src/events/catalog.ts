...
export const EVENT_CATALOG: EventTypeDef[] = [
  ...
  { type: 'crm.signal.reviewed', module: 'crm', description: 'CRM signal reviewed or researched by a user', severity: 'INFO' },
  ...
  { type: 'crm.signal.duplicated', module: 'crm', description: 'CRM signal classified as a duplicate', severity: 'INFO' },
  ...
  { type: 'projects.risk.raised', module: 'projects', description: 'Project risk registered — an uncertain future threat to delivery', severity: 'INFO' },
  { type: 'projects.risk.status_changed', module: 'projects', description: 'Project risk lifecycle moved, with the previous status and any acceptance reason', severity: 'INFO' },
  { type: 'projects.risk.materialised', module: 'projects', description: 'A project risk occurred and became a live issue; the risk record is preserved, not mutated', severity: 'ACTION_REQUIRED' },
  { type: 'projects.issue.raised', module: 'projects', description: 'Project issue registered — a condition that exists now and blocks or damages delivery', severity: 'ACTION_REQUIRED' },
  { type: 'projects.issue.status_changed', module: 'projects', description: 'Project issue lifecycle moved; resolving one never touches the records it references', severity: 'INFO' },
